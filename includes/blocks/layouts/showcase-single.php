...
<figure class="w-full flex-1 rounded-md shadow-md overflow-hidden"><a class="" href="<?php echo get_the_permalink($content->ID);?><?php echo get_the_post_thumbnail($content->ID,'full', array( 'class' => 'w-full lgw-3/5' ));?></a></figure>
