...
<figure class="w-full flex-1 overflow-hidden relative"><a class="" href="<?php echo get_the_permalink($content->ID);?>"><?php echo get_the_post_thumbnail($content->ID,'full', array( 'class' => 'w-full rounded-md shadow-md object-contain max-h-[70vh]' ));?>
